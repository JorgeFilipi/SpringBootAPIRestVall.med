...
public class pacienteController {
    ...
    public ResponseEntity cadastrar(@RequestBody @Valid DadosCadastroPaciente dados, UriComponentsBuilder uriBuilder){
        ...
        if (repository.existsByEmail(dados.email()) || repository.existsByCpf(dados.cpf())) {
            return ResponseEntity.badRequest().body("Já existe um paciente com esse email ou CPF");
        } else {
